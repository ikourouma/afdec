        ...
        <div className="flex-1 bg-zinc-900/20 border border-zinc-800/50 rounded-sm p-8 md:p-12 mb-20">
          ...
          {activeTab === 'privacy' && (
            <div className="animate-fade-in space-y-8">
               ...
               <div className="prose prose-invert prose-zinc max-w-none prose-h3:text-blue-400 prose-h3:text-lg prose-h3:tracking-wide">
                 <p>The African Diaspora Economic Council (AfDEC) operates under Tier-1 data sovereignty regulations. This protocol dictates the absolute safeguarding of enterprise and delegate telemetry traversing our international network corridors.</p>
          ...
          {activeTab === 'tos' && (
            <div className="animate-fade-in space-y-8">
               ...
               <div className="prose prose-invert prose-zinc max-w-none prose-h3:text-blue-400 prose-h3:text-lg prose-h3:tracking-wide">
                 <p>By bypassing the AfDEC Gateway and accessing our Deal Rooms or public Intelligence outputs, you agree to rigorous corporate operating behaviors.</p>
          ...
          {activeTab === 'cookies' && (
            <div className="animate-fade-in space-y-8">
               ...
               <div className="prose prose-invert prose-zinc max-w-none prose-h3:text-blue-400 prose-h3:text-lg prose-h3:tracking-wide">
                 <p>We deploy critical systems cookies solely for routing efficiency and high-level behavioral telemetry. This ensures our Deal Rooms load instantly regardless of your geographical location.</p>
          ...
          {activeTab === 'a11y' && (
            <div className="animate-fade-in space-y-8">
               ...
               <div className="prose prose-invert prose-zinc max-w-none prose-h3:text-blue-400 prose-h3:text-lg prose-h3:tracking-wide">
                 <p>Execution requires clarity. AfDEC is committed to ensuring our platform is structurally robust and readable for all delegates, regardless of visual or physical interfacing parameters.</p>
